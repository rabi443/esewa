    ...
    <div class="card" style="width:400px">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo $epay_url ?>" method="POST">
                ...
                <input type="hidden" id="transaction_uuid" name="transaction_uuid" value="<?php echo $pid ?>" required>
                ...
                <input type="hidden" id="failure_url" name="failure_url" value="<?php echo $failedurl ?>" required>
                ...
                <input value="Pay with Esewa Rs 110" type="submit" class="btn btn-primary">
            </form>
        </div>
    </div>
